...
# name, age, gender, movies, payments, snacks, drinks, times
...
paymentList = ['현금', '체크카드', '신용카드', '카카오페이', '네이버페이']
paymentPercent = [5, 30, 35, 20, 10]
snackList = ['선택 안함', '일반 팝콘', '캬라멜 팝콘', '나초', '오징어', '맛밤']
snackPercent = [40, 10, 20, 15, 10, 5]
drinkList = ['선택 안함', '콜라', '제로 콜라', '물', '에이드', '스프라이트', '오렌지주스']
...
data = {
    ...
    'payments': [random.choices(paymentList, weights=paymentPercent, k=1)[0] for i in range(500)],
